...
module.exports = class DeprecationCopStatusBarView {
  ...
  constructor() {
    ...
    // The Grim registry can contain a large stack tree. Keep the status tile
    // itself synchronous, but defer the first scan and listener registration
    // until the activation batch has yielded.
